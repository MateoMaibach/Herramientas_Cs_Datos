...
- Normalización de horas (formato 24hs y relleno con 00:00).
- Limpieza de texto en ubicaciones y patentes (mayúsculas y regex).
- Tratamiento de nulos y eliminación de outliers en velocidad_registrada.
